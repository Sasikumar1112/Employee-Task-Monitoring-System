...
<div class="center">
 ...
 <div class="txt-field">
            <p><input type="text" placeholder="Project Name" name="project_name" required></p>
        </div>
            <p><input type="submit" value="Create new Project"></p>
        </form>  
<%try{
	System.out.println("At Project block");
	//get par
